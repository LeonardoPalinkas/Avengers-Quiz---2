...
class ViewController: UIViewController {
    ...
    //    var perguntaAtual = DadosUltron.shared.perguntasUltron[DadosUltron.shared.perguntaAtualUltron]
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        let perguntaAtual = DadosUltron.shared.perguntasUltron[0]
        ...
        for b in self.button {
            b.backgroundColor = #colorLiteral(red: 0.7643429637, green: 0.2773319483, blue: 0.2763116658, alpha: 1)
        }
    ...
    @IBAction func respostaPressed(_ sender: UIButton) {
        ...
        if !respondido{
            let perguntaAtual = DadosUltron.shared.perguntasUltron[DadosUltron.shared.perguntaAtualUltron]
            ...
            respondido = true
            DadosUltron.shared.respondeu(pergunta: perguntaAtual, resposta: sender.tag)
            print(DadosUltron.shared.resultado())
    ...
    @IBAction func proximaPergunta(_ sender: Any) {
        ...
        let numeroDePerguntas = DadosUltron.shared.perguntasUltron.count - 1
        
        if DadosUltron.shared.perguntaAtualUltron >= numeroDePerguntas {
            if let vC =
                storyboard?.instantiateViewController(withIdentifier: "result") as? ResultViewController{
